                ...
                @foreach ($transmissions as $transmission)
                    <div class="client marque">
                        ...
                        <div>
                            ...
                            <button style="color: red" onclick="deleteTransmission(this)" data-url="{{route('admin.transmission.delete', ['idtransmission' => $transmission->id])}}"><i class=".los fa-solid fa-trash-can"></i></button>
                        </div>
                    </div>
                @endforeach
                {{-- <div class="client marque">
...
@section('notification')
    <div class="admining admining_marque">
        ...
        <div class="admining-box">
            ...
            <form method="POST" action="{{route('admin.transmission.store')}}">
                @csrf
                <label for=""></label>
                <input type="text" name="name" placeholder="Entrez le nom de la transmission">
...
@section('scriptjs')
    <script>
        function deleteTransmission(button) {
            const url = button.getAttribute('data-url');
            const isConfirmed = confirm("Voulez-vous supprimer cette transmission ?");
            if (isConfirmed) {
                fetch(url, {
                        method: 'DELETE',
                        headers: {
                ...
                alert("La transmission n'a pas été supprimé.");
            }
        }
    </script>
@endsection
