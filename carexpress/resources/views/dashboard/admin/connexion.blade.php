...
<html lang="en">
  ...
  <link
    rel="shortcut icon"
    href="{{asset('source/images/logo/logoB.png')}}"
    type="image/x-icon"
  />
  <link
  ...
  <body>
    <div class="section1 w-full overflow-hidden">
      <div class="navbar w-full h-40 bg-white shadow-lg fixed z-10 flex justify-between mx-auto items-center p-02 pt-5 lg:px-20 pt-5">
          <div class="logo flex items-center cursor-pointer">
              <a href="../../acceuil.html"><img src="{{asset('source/images/logo/logoR.png')}}" alt="Logo" class="w-24 h-24 md:w-32 md:h-16"></a>
          </div>
          ...
          <div class="md:hidden">
              <button id="menu-button" class="text-black text-2xl cursor-pointer outline-none"><i class="fa-solid fa-bars"></i></button>
          </div>
      </div>
      <div id="mobile-menu" class="hidden md:hidden flex flex-col items-center space-y-4 mt-01">
          ...
          <a href="../../dashboard/admin/dashboard.html" class="text-lg text-black hover:text-red-600">Mon dashboard</a>
          <a href="./connexion.html" class="text-lg text-black hover:text-red-600">Deconnexion</a>
      </div>
      
      
      
      <div class="container1 bg-cover bg-center bg-no-repeat h-5/6 w-11/12 mx-auto mt-40 flex flex-col md:flex-row items-center justify-between rounded-b-3xl" style="background-image: linear-gradient(90deg, hwb(0 44% 35% / 0.856), #c51e1edc), url('../source/images/bg1.jpeg');">
        <div class="textAcceuil text-white uppercase text-xl md:text-1xl lg:text-3xl font-black md:w-2/2 p-8 md:p-16">
            <div>Bienvenue SUR la page d'administration !</div>
            <p class="annonce mt-4 mb-4 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl 2xl:text-2xl font-light lowercase">
  ...
  <div class="container mx-auto p-4 max-w-md mb-10">
    ...
    <div class="container__form container--signin bg-white rounded-lg shadow-md p-6 mt-4 -translate-y-4 transition-transform flex flex-col">
        <form action="#" class="form" id="form2">
            <h1 class="form__title text-center text-2xl font-semibold mb-10">Connexion</h1>
            <input type="email" placeholder="Nom d'utilisateur" class="input mt-5 mb-4 p-3 w-full rounded outline-none border border-red-200 shadow-md" />
            <div class="relative">
              <input type="password" id="passwordInput" placeholder="Mot de passe" class="input mt-3 mb-5 p-3 w-full rounded outline-none border border-red-200 shadow-md" />
              <span id="togglePassword" class="eye-icon absolute transform translate-y-6 -translate-x-6 cursor-pointer">
            ...
            <!-- <a href="./inscription.html" class="link text-end text-reg-500 hover:underline block mb-5 p-2 text-right">S'inscrire</a> -->
            <button class="btn bg-green-500 hover:bg-green-700 focus:outline-none text-white font-bold py-2 px-4 rounded w-full">
                Se connecter
            </button>
        </form>
    </div>
    ...
    <div class="section6 w-full bg-gray-800 text-white py-10">
      <footer class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-4 justify-items-center md:mt-38">
          ...
          <div class="partenaire flex flex-col items-center md:items-start">
              ...
              <img src="{{asset('source/images/logo/logoB.png')}}" alt="logo-partenaires" class="w-24 filter grayscale hover:filter-none" />
          </div>
          <div class="newsletters flex flex-col items-center md:items-start">
              ...
              <form action="#" class="space-y-4">
                  <input placeholder="E-mail" type="email" name="#" class="w-full px-4 py-2 rounded-md text-gray-800 outline-none" />
