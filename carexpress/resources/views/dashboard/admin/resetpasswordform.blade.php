...
<body>
    ...
    <div class="container mx-auto p-4 max-w-md mb-10">
        ...
        <div
            ...
            <form action="{{ route('personnel.resetpassword') }}" method="POST" class="form" id="form2">
                <h1 class="form__title text-center text-2xl font-semibold mb-10">Modifier le mot de passe </h1>
                @if (session('success'))
                ...
                <div class="relative">
                    <input type="password" id="passwordInput" name="password_confirmation" placeholder="Confimer le mot de passe"
                        class="input mt-3 mb-5 p-3 w-full rounded outline-none border border-red-200 shadow-md" />
                    <span id="togglePassword"
                        class="eye-icon absolute transform translate-y-6 -translate-x-6 cursor-pointer">
                        <i class="fas fa-eye text-gray-500 hover:text-gray-700"></i>
                ...
                <a href="#" class="link text-blue-500 hover:underline block mb-5 p-2"></a>
                <button
