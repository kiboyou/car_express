...
<head>
    ...
    <title>Invoice Customer {{$codeclient}}</title>
                                    ...
                                    <table class="border-collapse border-spacing-0">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="pl-4">
                                                    <div>
                                                        <p class="whitespace-nowrap text-slate-400 text-right">Received
                                                            N°</p>
                                                        <p class="whitespace-nowrap font-bold text-main text-right">
                                                            {{ $numreceived }}</p>
                                                    </div>
                ...
                <table class="w-full border-collapse border-spacing-0">
                    <thead>
                        <tr>
                            ...
                            <td class="border-b-2 border-main pb-3 pl-2 text-right font-bold text-main">Reservation</td>
                            <td class="border-b-2 border-main pb-3 pl-2 text-center font-bold text-main">Facture</td>
                            <td class="border-b-2 border-main pb-3 pl-2 text-center font-bold text-main">Montant Total</td>
                            <td class="border-b-2 border-main pb-3 pl-2 text-right font-bold text-main">Montant Versé</td>
                            <td class="border-b-2 border-main pb-3 pl-2 pr-3 text-right font-bold text-main">Montant Restant</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
