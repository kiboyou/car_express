                ...
                <table class="w-full border-collapse border-spacing-0">
                    <thead>
                        <tr>
                            ...
                            <td class="border-b-2 border-main pb-3 pl-2 text-center font-bold text-main">Days</td>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border-b py-3 pl-2 text-right">{{ $locationprice }} €</td>
                            <td class="border-b py-3 pl-2 text-center"> {{ $daynum }} </td>
                            <td class="border-b py-3 pl-2 text-center">10%</td>
                            <td class="border-b py-3 pl-2 text-right">{{ $montant }} €</td>
                            <td class="border-b py-3 pl-2 pr-3 text-right">{{ $total }} €</td>
                        </tr>
                        <tr>
                            <td colspan="7">
                                <table class="w-full border-collapse border-spacing-0">
